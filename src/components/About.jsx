...
const About = () => {
  return (
    ...
    w-full overflow-hidden" id="About">
        ...
        <p className="text-gray-500 max-w-80 text-center mb-8">Passionate About Proparties, Dedicated to Your Vision</p>
           ...
           <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
            <div className="grid grid-cols-2 gap-6 md:gap-10 w-full 2x1:pr-28">
               ...
               <p className="my-10 max-w-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                 Saepe, tenetur! Rerum, nostrum? Hic quam rerum culpa? Explicabo earum reprehenderit vel,
                  </p>
